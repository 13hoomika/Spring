...
<div class="container">
    ...
    <form action="enrollments" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="courseName" id="courseNameID" required>
        ...
        <div class="form-group">
            ...
            <textarea name="comments" id="comments" placeholder="Enter your comments (optional)" rows="4"></textarea>
        </div>

        <button type="submit">Enroll Now</button>
    </form>

    <a href="getEnrollments">View Enrollments</a>
