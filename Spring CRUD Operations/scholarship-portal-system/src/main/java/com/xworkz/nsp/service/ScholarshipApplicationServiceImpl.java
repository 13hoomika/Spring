...
import com.xworkz.nsp.entity.ScholarshipApplicationEntity;
import com.xworkz.nsp.repository.ScholarshipApplicationRepository;
...
public class ScholarshipApplicationServiceImpl implements ScholarshipApplicationService {
    ...
    @Override
    public void ValidateAndSAve(ScholarshipApplicationDto dto) {
        ValidatorFactory validatorFactory = Validation.buildDefaultValidatorFactory();
        Validator validator = validatorFactory.getValidator();
        Set<ConstraintViolation<ScholarshipApplicationDto>> validate = validator.validate(dto);
        if (validate.isEmpty()){
